  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6">
        ...
        <div className="bg-white border rounded-lg p-6">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Protein: {(() => {
                const total = (stats?.averageProtein || 0) + (stats?.averageCarbs || 0) + (stats?.averageFat || 0);
      ...
      <div className="bg-white border rounded-lg p-6 mb-8">
        <div className="text-lg font-semibold mb-4">📊 Weekly Progress Review</div>
        {reviewLoading ? (
          ...
          <div className="text-gray-700 leading-relaxed">
            {progressReview}
            <div className="text-xs text-gray-400 mt-2">Generated by AI</div>
          </div>
        )}
      </div>
